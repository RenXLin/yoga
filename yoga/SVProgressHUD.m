...
+ (SVProgressHUD*)sharedView {
    ...
    dispatch_once(&once, ^ {
        ...
        //支持ios8系统：
//        if (IS_IOS8) {
//            NSLog(@"%@",NSStringFromCGPoint(sharedView.center));
//               sharedView.transform = CGAffineTransformTranslate(sharedView.transform, 30, 0);
//        }
    });
    return sharedView;
}
...
//    self.hudView.center = CGPointMake(512, newCenter.y);

//    NSLog(@"%@",NSStringFromCGRect(self.hudView.frame));
}
