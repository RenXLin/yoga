...
+(void)showCustomstatus:(NSString *)string; {
    [[SVProgressHUD sharedView] showCustomstatus:string];
}
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.maskType) {
        ...
        case SVProgressHUDMaskTypeCustom:
        {
            ...
            [[UIColor colorWithWhite:0.2 alpha:0.7] set];
            CGContextFillRect(context, self.bounds);
            ...
            for(int i=1;i<43;i++)
            {
                if(i<10)
                {
                    [array addObject:[UIImage imageNamed:[NSString stringWithFormat:@"加载动画000%d",i]]];
                }
                else
                {
                     [array addObject:[UIImage imageNamed:[NSString stringWithFormat:@"加载动画00%d",i]]];
                }
            }
...
//        self.imageView.center = CGPointMake(CGRectGetWidth(self.hudView.bounds)/2, 36);
        self.imageView.center = CGPointMake(CGRectGetWidth(self.bounds)/2, 150);
	else
//       	self.imageView.center = CGPointMake(CGRectGetWidth(self.hudView.bounds)/2, CGRectGetHeight(self.hudView.bounds)/2);
        self.imageView.center = CGPointMake(CGRectGetWidth(self.bounds)/2, CGRectGetHeight(self.hudView.bounds)/2);
	
	self.stringLabel.hidden = NO;
	self.stringLabel.text = string;
	self.stringLabel.frame = CGRectMake((320-stringWidth)/2.0, 150+28+10, stringWidth, stringHeight);
...
//        customImg.frame=CGRectMake(0, 0, 43, 28);
//        customImg.center= CGPointMake(self.bounds.size.width/2, self.bounds.size.height/2);
//        [self addSubview:customImg];
       ...
       self.imageView.animationDuration=1.0;
        ...
        self.imageView.hidden = NO;
        [self setStatus:string];
        self.bounds=CGRectMake(0, 0, 43, 28);
        [self.spinnerView stopAnimating];
...
//          /* 改frame */
//        hudView.frame=CGRectMake(160, 100, 100, 100);
//        hudView.layer.cornerRadius = 10;
//          /* 改了透明度 */
//		hudView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.0];
...
//        stringLabel = [[UILabel alloc] initWithFrame:CGRectZero];
         stringLabel = [[UILabel alloc] initWithFrame:CGRectMake((320-100)/2.0, 150+28+10, 100, 20)];
...
- (UIImageView *)imageView {
    if (imageView == nil)
//        imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 43, 28)];
        imageView = [[UIImageView alloc] initWithFrame:CGRectMake((320-43)/2.0, 150, 43, 28)];
